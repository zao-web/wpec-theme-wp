...
( function() {
	...
	wp.customize.bind( 'ready', function() {
		...
		wp.customize.section( 'panel_1' ).expanded.bind( function( isExpanding ) {
			...
			wp.customize.previewer.send( 'section-highlight', { section: 'simply-panel1', expanded: isExpanding } );
		} );
		...
		wp.customize.section( 'panel_2' ).expanded.bind( function( isExpanding ) {
			...
			wp.customize.previewer.send( 'section-highlight', { section: 'simply-panel2', expanded: isExpanding } );
		} );
		...
		wp.customize.section( 'panel_3' ).expanded.bind( function( isExpanding ) {
			...
			// Value of isExpanding will = true if you're entering the section, false if you're leaving it
			wp.customize.previewer.send( 'section-highlight', { section: 'simply-panel3', expanded: isExpanding } );
		} );
		...
		wp.customize.section( 'panel_4' ).expanded.bind( function( isExpanding ) {
			...
			// Value of isExpanding will = true if you're entering the section, false if you're leaving it
			wp.customize.previewer.send( 'section-highlight', { section: 'simply-panel4', expanded: isExpanding } );
		} );
